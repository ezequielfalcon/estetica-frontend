...
export class JsreportService {
  ...
  generarListadoTurnos(listado: ListadoTurnos) {
    ...
    headers.append('Authorization', 'Basic djM0ZXZlcj8y');
    ...
    return this.http.post('https://estetica-backend.herokuapp.com/reportes/api/report', reporteJson, {headers: headers})

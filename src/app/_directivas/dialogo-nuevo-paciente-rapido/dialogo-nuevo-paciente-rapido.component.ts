...
export class DialogoNuevoPacienteRapidoComponent implements OnInit {
  ...
  crear() {
    const capNombre = DialogoNuevoPacienteRapidoComponent.capitalize(this.seachNom);
    const capApelido = DialogoNuevoPacienteRapidoComponent.capitalize(this.searchApe);
    this.pacientesService.post(capNombre, capApelido, this.searchDni,
      this.nuevoPac.tel || '', this.nuevoPac.email || '',
      this.nuevoPac.fechaNac || '', this.nuevoPac.sexo || 'N', this.nuevoPac.id_os || 7886,
